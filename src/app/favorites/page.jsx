...
const FavoriteProducts = () => {
  ...
  }, [favorites, session?.user?.id, sessionStatus]);
          ...
          {favoriteProducts?.length ? (
            <div className="favorite-products-container">
              <span className="favorite-products-info">
                ...
                <p className="favorite-products-text-2">
                  {" "}
                  (Haz click sobre el icono de corazón para eliminar de
                  favoritos.)
                </p>
              </span>
            ...
            <span className="favorites-empty">
              ...
              <p className="empty-text ">
                Cada vez que agregues un producto a favoritos, aparecerán en
                esta sección.
              </p>
