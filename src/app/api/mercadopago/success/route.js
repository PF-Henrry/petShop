...
export async function GET(request) {
  try {
    ...
    mercadopago.configure({
      access_token:
        "TEST-2888310693624060-010504-9f0a277f30e529f53801260e864633d8-1624877440",
    });
    ...
    if (status === "approved") {
      ...
      if (Array.isArray(findOrder.items)) {
        for (let item of findOrder.items) {
          ...
          if (id && count) {
            ...
            if (findProduct) await findProduct.remStock(count);
